...
Welcome to this workshop, part of **{{< param product_name >}}**. In the Core lab **Terms — Namespaces & Tenancy** you learned
...
This workshop assumes you have done the Core lab **Terms — Namespaces & Tenancy**, so you
