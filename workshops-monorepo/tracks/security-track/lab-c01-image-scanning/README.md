...
- **Track / module:** Security & Compliance — Secure on DCS (Module C) · Lab 1 of 5
...
- **Prerequisites:** lab-a04-harbor-registry · external: basic Linux CLI, familiarity with containers and CVEs
