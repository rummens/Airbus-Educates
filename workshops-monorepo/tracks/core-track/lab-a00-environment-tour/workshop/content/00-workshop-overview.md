...
- Use the **quick actions** — the clickable boxes that run commands, open files and check your work.
- Describe the two halves of the dashboard — the **instructions** and the **work area**.
- Use the **split terminal** — run a command in the upper pane and in the lower pane.
- Open a file in the **editor** from a quick action.
