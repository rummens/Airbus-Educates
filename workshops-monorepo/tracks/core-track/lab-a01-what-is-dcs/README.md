...
**Your first 20 minutes on the Digital Container Service — no container experience needed.**

The Digital Container Service (DCS) is Airbus Defence and Space's on-prem, air-gapped,
OpenShift-based container platform. This opening lab gets you oriented before anything
else: what the platform is and where it fits, what containers and images actually are,
