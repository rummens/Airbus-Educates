...
- **Deploy Your First App** You know Deployments, Pods, and the
  Deployment → ReplicaSet → Pod chain.
- **Configure & Troubleshoot Your App** You know ConfigMaps and how a config
...
This lab does **not** re-teach what a Deployment, Service or ConfigMap *is* — the **Deploy Your First App** lab/the **Configure & Troubleshoot Your App** lab
