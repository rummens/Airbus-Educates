...
already used in the **Configure & Troubleshoot Your App** lab to hold this app's config — here you're recreating that same idea by
...
a replacement Pod carrying the new environment — the same rollout mechanic from the **Configure & Troubleshoot Your App** lab, now
