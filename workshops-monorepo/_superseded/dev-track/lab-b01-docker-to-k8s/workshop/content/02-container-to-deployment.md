...
You already built one of these by hand in the **Deploy Your First App** lab — this time you're translating an existing
...
The shape should look familiar from the **Deploy Your First App** lab/the **Configure & Troubleshoot Your App** lab: `replicas: 1`, a `selector` and Pod
