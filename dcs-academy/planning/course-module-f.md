...
**Covers ideas:** 25
**Type:** Elective (Operators)
**Prerequisites:** B08 (B01 helpful — you deploy an app via GitOps)
...
**Covers ideas:** 26
**Type:** Elective (Operators)
**Prerequisites:** B08 (A07 storage helpful — a database needs a PVC)
...
**Design notes:** CNPG is the lightest of the three → best candidate for a **fully live hands-on** (and it's reused as the demo operator in B08). Emphasise the DBaaS-vs-operator ownership contrast hardest here — it's the most common expectation mismatch.
...
- **Ownership deep-dive** is established once in **B08** (Developer) and applied per-service here — don't re-teach the operator pattern, apply it.
