...
## Review comments
Route requires PROD type NS, please include that in the explanation. We can proviosn this for this lab though
Right now customers cannot create Network Polices themselves but this is on the roadmap